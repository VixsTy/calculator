...
require (
	github.com/CircleCI-Public/circleci-cli v0.1.5830
	github.com/SimonWaldherr/golang-minigames v0.0.0-20160314021437-a3fadf5e2073
	github.com/VixsTy/grimoire v0.0.1
